...
class _BookingDetailEntryFormState extends State<BookingDetailEntryForm> {
  ...
  void initData() {
    ...
    _amountController = TextEditingController(
        text: enquiryProvider.selectedCaseModel != null ? enquiryProvider
            .selectedCaseModel.bookingDetails.amount : "");
  }
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  ButtonTheme(minWidth: MediaQuery
                      .of(context)
                      .size
                      .width - 200,
              ...
              DropdownButtonFormField(
                  ...
                  onChanged: (val) {
                    formData.selectedSalesExecutive = val;
                  }
              ),
              SizedBox(height: LINE_HEIGHT,),
              DropdownButtonFormField(
                  ...
                  onChanged: (val) {
                    formData.selectedPaymentType = val;
                  }
              ),
              SizedBox(height: LINE_HEIGHT,),
              DropdownButtonFormField(
                  ...
                  child: RaisedButton(onPressed: () async {
                    if (_formKey.currentState.validate()) {
                      ...
                      BookingDetails bookingDetails = new BookingDetails(
                          salesexecutive: formData.selectedSalesExecutive,
                          paymentType: formData.selectedPaymentType,
                          amount: _amountController.text,
                          source: formData.selectedSource
                      );
                      formData.activeStep = 4;
                      currentProvider.caseModel.bookingDetails = bookingDetails;
                      String dataBase64 = currentProvider.caseModel
                          .getFinalData();
                      bool status = await currentProvider.saveTransaction(
                          userProvider.UserID, userProvider.SessionID,
                          dataBase64);
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(FINISH, style: AppFontStyle.buttonTextStyle(
                              APP_WHITE_COLOR),),
                          SizedBox(width: TEXT_WIDTH,),
                          Icon(Icons.done, size: ARROW_RIGHT,
              ...
              Row(
                ...
                children: [
                  Icon(
                    LineIcons.trash_o, color: APP_RED_COLOR, size: ICON_SIZE,),
                  Text(DELETE_CASE,
                    style: AppFontStyle.bodyTextStyle(APP_RED_COLOR),),
                ],
              ),
            ]
        )
          ...
          return AlertDialog(
              ...
              title: Column(
                  ...
                  children: [
                    ...
                    Text("You have punched the enquiry successfully",
                      style: AppFontStyle.labelTextStyle(APP_BLACK_COLOR),
