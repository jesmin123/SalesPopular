...
class _OldCarDetailEntryFormState extends State<OldCarDetailEntryForm> {
  ...
  void initData() {
    ...
    _remarksController = TextEditingController(
        text: enquiryProvider.selectedCaseModel != null
            ? enquiryProvider.selectedCaseModel.oldCarDetails.remarks
            : "");
  }
        ...
        child: Column(
          children: [
            ...
            DropdownButtonFormField(
                ...
                onChanged: (value) {
                  formData.selectedExchangeCarMakes = value;
                }),
            SizedBox(
              height: LINE_HEIGHT,
            ),
            DropdownButtonFormField(
                ...
                items: widget._formData.exchangeCarModels.map((e) {
                  return DropdownMenuItem(
                    child: Text(e['otherCarModel']),
                    value: e['otherCarModel'],
                  );
                }).toList(),
                onChanged: (value) {
                  formData.selectedExchaneCarModels = value;
                }),
            SizedBox(
              height: LINE_HEIGHT,
            ),
            DropdownButtonFormField(
                ...
                items: widget._formData.exchangeCarVariants.map((e) {
                  return DropdownMenuItem(
                    child: Text(e['otherCarVariant']),
                    value: e['otherCarVariant'],
                  );
                }).toList(),
                onChanged: (value) {
                  formData.selectedExchangeCarVariants = value;
                }),
            SizedBox(
              height: LINE_HEIGHT,
            ),
            DropdownButtonFormField(
                ...
                onChanged: (val) {
                  formData.selectedExchangeCarColours = val;
                }),
            SizedBox(
              height: LINE_HEIGHT,
            ),
            DropdownButtonFormField(
                ...
                onChanged: (value) {
                  formData.selectedExchangeBranch = value;
                }),
            SizedBox(
              height: LINE_HEIGHT,
            ),
            DropdownButtonFormField(
                ...
                onChanged: (value) {
                  formData.selectedExchangeCarEvaluators = value;
                }),
            SizedBox(
              height: LINE_HEIGHT,
            ),
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                enabledBorder: AppBorderStyle.getFormBorder(),
                focusedBorder:
                    AppBorderStyle.getFormBorder(color: PRIMARY_COLOR),
              ),
            ),
            SizedBox(
              height: LINE_HEIGHT,
                ...
                onPressed: () {
                  if (_formKey.currentState.validate()) {
                    OldCarDetails oldCarDetails = new OldCarDetails(
                        exchangeCarMake: formData.selectedExchangeCarMakes,
                        exchangeCarModel: formData.selectedExchaneCarModels,
                        exchangeCarVariant:
                            formData.selectedExchangeCarVariants,
                        exchangeCarColor: formData.selectedExchangeCarColours,
                        evalutorName: formData.selectedExchangeCarEvaluators,
                        evalutorBranch: formData.selectedExchangeBranch,
