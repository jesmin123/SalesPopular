      ...
      body: SafeArea(
        child: Padding(
          ...
          child: FAStepper(
              ...
              steps:[
                  FAStep(state: formData.activeStep>0?FAStepstate.complete:FAStepstate.editing, title: Text(CUSTOMER_DETAIL,style: AppFontStyle.bodyTextStyle(APP_BLACK_COLOR),textAlign: TextAlign.center,), content: CustomerDetailEntryForm(),isActive: formData.stepCount==0),
